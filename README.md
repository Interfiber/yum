...
## Adding recipes
Just add a markdown file to ```site/recipes```. Then link to it in ```site/index.md``` just please make sure if this recipe is not yours then link to the original source. Then submit a PR on GitHub.
